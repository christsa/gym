...
class RobotEnv(gym.GoalEnv):
    ...
    def step(self, action):
        ...
        # self.goal[-15:] = self.data_array[self.step_counter]
        ...
        #   print(reward)
        #   print('True small')
        # ftip_pos = [self.sim.data.get_site_xpos(name) for name in FINGERTIP_SITE_NAMES]
        # sites_offset = (self.sim.data.site_xpos - self.sim.model.site_pos).copy()
        # #pdb.set_trace()
        # for finger_idx in range(5):
        #     site_name = 'target_{}'.format(finger_idx)
        #     site_id = self.sim.model.site_name2id(site_name)
        #     self.sim.model.site_pos[site_id] = ftip_pos[finger_idx] - sites_offset[site_id]
